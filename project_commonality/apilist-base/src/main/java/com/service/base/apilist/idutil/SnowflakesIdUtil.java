...
public class SnowflakesIdUtil {
    ...
    volatile private static SnowflakesIdUtil instance = new SnowflakesIdUtil();

    private SnowflakesIdUtil() {
     ...
     */
    public SnowflakesIdUtil(long workerId, long datacenterId) {
    ...
    public static SnowflakesIdUtil getInstance() {
        return instance;
    }
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 10; i++) {
            long id = SnowflakesIdUtil.getInstance().nextId();
